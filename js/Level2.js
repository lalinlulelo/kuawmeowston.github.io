...
function Level2() {
    ...
    function Update() {
        ...
        if (Jugadores == 2) {
            CheckCollisions(player_2, enemy_2); //colisiones del enemigo con las balas del jugador 2
            CheckCollisions(enemy_2, player_2); //colisiones del jugador 2 con las balas del enemigo
        }
    ...
    function DrawChars() {
        ...
        if (!enemy_2.dead) {
            ...
            //Segun el carril, pintarlo en una capa u otra
            switch (carril) {
                case 0: capa0ctx.drawImage(enemy_2.sprite, enemy_2.posX, enemy_2.posY, enemy_2.carril.x, enemy_2.carril.y);
                    break;
                case 1: capa1ctx.drawImage(enemy_2.sprite, enemy_2.posX, enemy_2.posY, enemy_2.carril.x, enemy_2.carril.y);
                    break;
                case 2: capa2ctx.drawImage(enemy_2.sprite, enemy_2.posX, enemy_2.posY, enemy_2.carril.x, enemy_2.carril.y);
                    break;
            }
        }       
    }
    ...
    function SaveScore() {
        ...
        var puntos = parseInt((0.3/segundos)*1000;
