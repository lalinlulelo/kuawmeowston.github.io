...
function Level3() {
    ...
    function Init () {
        ...
        //Inicializar enemigo
        enemy_3 = new Enemy(20, 'images/tostadora.png', 'images/tostadora_bullet.png', 'images/tostadora_damaged.png', 'images/tostadora_killed.png', 9);
    ...
    function Update() {
        ...
        //Colisiones
        CheckCollisions(player_1, enemy_3); //colisiones del enemigo con las balas del jugador 1
        CheckCollisions(enemy_3, player_1); //colisiones del jugador 1 con las balas del enemigo
        if (Jugadores == 2) {
            CheckCollisions(player_2, enemy_3); //colisiones del enemigo con las balas del jugador 2
            CheckCollisions(enemy_3, player_2); //colisiones del jugador 2 con las balas del enemigo
        }
    ...
    function DrawChars() {
        ...
        if (!enemy_3.dead) {
            ...
            //Segun el carril, pintarlo en una capa u otra
            switch (carril) {
                case 0: capa0ctx.drawImage(enemy_3.sprite, enemy_3.posX, enemy_3.posY, enemy_3.carril.x, enemy_3.carril.y);
                    break;
                case 1: capa1ctx.drawImage(enemy_3.sprite, enemy_3.posX, enemy_3.posY, enemy_3.carril.x, enemy_3.carril.y);
                    break;
                case 2: capa2ctx.drawImage(enemy_3.sprite, enemy_3.posX, enemy_3.posY, enemy_3.carril.x, enemy_3.carril.y);
                    break;
            }
        }       
    }
    ...
    function DrawBullets () {
        ...
        if (enemy_3.life > 0) {
            for (var i = 0; i < enemy_3.bullets.length; i++) {
                var disparoMalo = enemy_3.bullets[i];
    ...
    function Update_Enemy_Bullet(bullet, id) {
        if (bullet) {
            ...
            if (bullet.posX >= 0) {
                ...
                enemy_3.DeleteShot(parseInt(bullet.identifier));
            }            
        }
    }
