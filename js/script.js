...
var game = (function () {
  ...
  function touchHandler(e) {
    ...
    function preloadImages (){
      ...
      enemy_1_bullet.zindex = 0; //profundidad de cada bala
    ...
    function enemy_3_carril_n(objeto) {
        ...
        if ((objeto.x == 190) && (objeto.y == 120)) {
            return 1;
        }
        if ((objeto.x == 190 * 0.3) && (objeto.y == 120 * 0.3)) {
            return 1;
        }
        if ((objeto.x == 150) && (objeto.y == 80)) {
            return 2;
        }
        if ((objeto.x == 150 * 0.3) && (objeto.y == 80 * 0.3)) {
            return 2;
        }
    }
    ...
    function Enemy_3() {
        ...
        enemy_3_carril.x = 380; 
        enemy_3_carril.y = 200; 
        ...
        function cambio_carril_3(carril) {
            switch (carril) {
                case 0:                    
                    enemy_3.bulletY = 550; 
                    enemy_3_carril.x = 220;
                    enemy_3_carril.y = 150;
                    break;
                case 1:                    
                    enemy_3.bulletY = 524;
                    enemy_3_carril.x = 190;
                    enemy_3_carril.y = 120;
                    break;
                case 2:                    
                    enemy_3.bulletY = 500;
                    enemy_3_carril.x = 150;
                    enemy_3_carril.y = 80;
                    break;
            }
        }
        ...
        function shoot() {
            if (enemy_3_life > 0) {
                setTimeout(function () {
                    ...
                    enemy_3_shoot.x = enemy_3_carril.x * 0.3; 
                    enemy_3_shoot.y = enemy_3_carril.y * 0.3;
                    //console.log(enemy_3_shoot.x + " " + enemy_3_shoot.y);
                    enemy_3_shoot.add();
                    shoot();
                    var random_carril = getRandomNumber(0, 2);
      ...
      if (enemy_1_shoot) {
        ...
        if (checkCollisions_Enemy_1(enemy_1_shoot)) {
          if (enemy_1_shoot.posX >= 0) {
              ...
              //Obtener carril de la bala
              enemy_1_shoot.zindex = enemy_1_carril_n(enemy_1_shoot);
              var carril = enemy_1_shoot.zindex;
              //Segun el carril, pintarlo en una capa u otra
              switch (carril) {
                  case 0: capa0ctx.drawImage(enemy_1_shoot.image, enemy_1_shoot.posX, enemy_1_shoot.posY, enemy_1_shoot.x, enemy_1_shoot.y);
                      break;
                  case 1: capa1ctx.drawImage(enemy_1_shoot.image, enemy_1_shoot.posX, enemy_1_shoot.posY, enemy_1_shoot.x, enemy_1_shoot.y);
                      break;
                  case 2: capa2ctx.drawImage(enemy_1_shoot.image, enemy_1_shoot.posX, enemy_1_shoot.posY, enemy_1_shoot.x, enemy_1_shoot.y);
                      break;
              }
            } else {
    ...
    function updateEnemy_3_Shoot(enemy_2_shoot, id) {
        if (enemy_3_shoot) {
            ...
            if (checkCollisions_Enemy_3(enemy_3_shoot)) {
                if (enemy_3_shoot.posX >= 0) {
                    ...
                    //bufferctx.drawImage(enemy_1_shoot.image, enemy_1_shoot.posX, enemy_1_shoot.posY, enemy_1_shoot.x, enemy_1_shoot.y);
                    //Obtener carril de la bala
                    enemy_3_shoot.zindex = enemy_3_carril_n(enemy_3_shoot);
                    var carril = enemy_2_shoot.zindex;
                    //Segun el carril, pintarlo en una capa u otra
                    switch (carril) {
                        case 0: capa0ctx.drawImage(enemy_3_shoot.image, enemy_3_shoot.posX, enemy_3_shoot.posY, enemy_3_shoot.x, enemy_3_shoot.y);
                            break;
                        case 1: capa1ctx.drawImage(enemy_3_shoot.image, enemy_3_shoot.posX, enemy_3_shoot.posY, enemy_3_shoot.x, enemy_3_shoot.y);
                            break;
                        case 2: capa2ctx.drawImage(enemy_3_shoot.image, enemy_3_shoot.posX, enemy_3_shoot.posY, enemy_3_shoot.x, enemy_3_shoot.y);
                            break;
                    }
                } else {
    ...
    function update() {
      ...
      if (FIREFOX) {
          ...
          if (enemy_2_life > 0 && enemy_2_created == true) {
              enemy_2.zindex = enemy_2_carril_n(enemy_2_carril);
          }
          if (enemy_3_life > 0 && enemy_3_created == true) {
              enemy_3.zindex = enemy_3_carril_n(enemy_3_carril);
          }
      } else {
      ...
      if (FIREFOX) {
        ...
        switch (enemy_id) {
            case 0:
                if (enemy_1_life > 0) {
                    ...
                    //Segun el carril, pintarlo en una capa u otra
                    switch (carril) {
                        case 0: capa0ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY + 250, enemy_1_carril.x, enemy_1_carril.y);
                            break;
                        case 1: capa1ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY + 250, enemy_1_carril.x, enemy_1_carril.y);
                            break;
                        case 2: capa2ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY + 250, enemy_1_carril.x, enemy_1_carril.y);
                            break;
                    }
                }
                break;
            ...
            case 2:
                if (enemy_3_life > 0) {
                    //obtener el carril en el que esta
                    var carril = enemy_3.zindex;
                    //Segun el carril, pintarlo en una capa u otra
                    switch (carril) {
                        case 0: capa0ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY + 250, enemy_3_carril.x, enemy_3_carril.y);
                            break;
                        case 1: capa1ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY + 250, enemy_3_carril.x, enemy_3_carril.y);
                            break;
                        case 2: capa2ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY + 250, enemy_3_carril.x, enemy_3_carril.y);
                            break;
                    }
                }
                break;
        ...
        switch(enemy_id){
          case 0:
            if(enemy_1_life > 0){
                ...
                //Segun el carril, pintarlo en una capa u otra
                switch (carril) {
                    case 0: capa0ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY, enemy_1_carril.x, enemy_1_carril.y);
                        break;
                    case 1: capa1ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY, enemy_1_carril.x, enemy_1_carril.y);
                        break;
                    case 2: capa2ctx.drawImage(enemy_1, enemy_1.posX, enemy_1.posY, enemy_1_carril.x, enemy_1_carril.y);
                        break;
                }
            }
            break;
        ...
        case 2:
            if(enemy_3_life > 0){
                ...
                //Segun el carril, pintarlo en una capa u otra
                switch (carril) {
                    case 0: capa0ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY, enemy_3_carril.x, enemy_3_carril.y);
                        break;
                    case 1: capa1ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY, enemy_3_carril.x, enemy_3_carril.y);
                        break;
                    case 2: capa2ctx.drawImage(enemy_3, enemy_3.posX, enemy_3.posY, enemy_3_carril.x, enemy_3_carril.y);
                        break;
                }
            }
            break;
